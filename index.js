...
console.log(carpma(7,4).toString())
 ...
 */
 ...
 function kopeginYasiHesaplama(yas){
  yas = yas * 7;
  return yas;
}
...
function oyun(oyuncu, bilgisayar) {
  ...
  const kagit = "Kağıt"
  const makas = "Makas"
  if ((oyuncu == tas && bilgisayar == kagit)||
     (oyuncu == kagit && bilgisayar == makas)||
     (oyuncu == makas && bilgisayar == tas)){
    return("Kaybettin!");}
...
function kmdenmiledonusturucu(mil) {
  return km * 0.621371
 }
